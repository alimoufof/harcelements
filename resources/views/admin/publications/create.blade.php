        ...
        <div class="content-header">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('publication.index')}}">Publication</a></li>
                <li class="breadcrumb-item active" aria-current="page">Ajouter une nouvelle publication</li>
              </ol>
            </nav>
        </div>
          <!--  Header BreadCrumb -->   
