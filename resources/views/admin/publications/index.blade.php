    ...
    <!--  Header BreadCrumb -->
     <div class="content-header">
         ...
         <div class="create-item">
             <a href="{{ route('publication.create') }}" class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>Ajouter une publication</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-end">
                                                <a class="btn btn-sm btn-secondary" href="{{route('publication.show', $publication)}}">Voir</a>  
                                                <a class="btn btn-sm btn-info" href="{{route('publication.edit', $publication)}}">Modifier</a>
