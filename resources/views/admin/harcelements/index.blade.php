     ...
     <div class="content-header">
         <nav aria-label="breadcrumb">
           <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item active" aria-current="page">Harcelements</li>
           </ol>
         </nav>
         <div class="create-item">
             <a href="{{ route('harcelement.create') }}" class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>Ajouter un harcelement</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-end">
                                                <a class="btn btn-sm btn-secondary" href="{{route('harcelement.show', $harcelement)}}">Voir</a>  
                                                <a class="btn btn-sm btn-info" href="{{route('harcelement.edit', $harcelement)}}">Modifier</a>
