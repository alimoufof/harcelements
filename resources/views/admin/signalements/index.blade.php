    ...
    <!--  Header BreadCrumb -->
     <div class="content-header">
         ...
         <div class="create-item">
             <a href="{{ route('signalement.create') }}" class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>Ajouter un signalement</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 justify-content-end">
                                                <a class="btn btn-sm btn-secondary" href="{{route('signalement.show', $signalement)}}">Voir</a>  
                                                <a class="btn btn-sm btn-info" href="{{route('signalement.edit', $signalement)}}">Modifier</a>
